...
- Изменена музыка в титрах после победы над тарелкой на композицию от `ThePlain`.
- Адаптирована скорость текста рассказчика в катсцене после победы над тарелкой.
- Изменён звук двигателя у Грейдера.
- Восстановлен истинный рост Феликса.

### Добавлено

- Добавлено огромное количество правок в диалогах и озвучке от `VELIKIY RUSS`.
- Добавлена секция `Community Disaster` в титры после победы над тарелкой.
- Добавлен звук, зомбирующий людей у упавшей тарелки.
- Добавлены в продажу топ-тир улучшения для огнестрельного оружия в крупные города второго региона.
